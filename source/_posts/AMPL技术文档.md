...
2. 求解器无关
    ...
    > 开源求解器和商业求解器的对比与选择：
    > - 大规模 MIP 整数规划：商业求解器，尤其是Gurobi优势巨大，剪枝、启发式、预处理算法强很多
    > - 线性规划 LP、二次规划 QP：HiGHS的性能已经接近商业求解器
    > - 非线性规划 NLP：商业求解器对锥优化、非线性问题支持更好
    > - 商业求解器在广义锥优化、半定规划 SDP、回调函数、多目标优化、热启动、并行分支切割、各类高级裁剪等方面也更有优势
3. 支持各类优化问题
